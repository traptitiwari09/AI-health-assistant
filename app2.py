...
def healthcare_chatbot(user_input):
    ...
    if "sneeze" in user_input or "sneezing" in user_input:
        ...
        return "A fever could indicate an infection. Stay hydrated, rest, and consult a doctor if the fever lasts for more than 48 hours."
    elif "cough" in user_input:
        return "A persistent cough might indicate a respiratory infection. Consider seeing a doctor if it continues for more than a week."
    elif "headache" in user_input:
        return "Headaches can be caused by stress, dehydration, or a range of medical conditions. Rest and hydration might help, but consult a doctor if severe or persistent."
